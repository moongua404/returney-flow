...
public class PipelineYamlParser {
  ...
  public PipelineDefinition parseFromClasspath(String resourcePath) {
    try (InputStream is = getClass().getClassLoader().getResourceAsStream(resourcePath)) {
      if (is == null) throw new PipelineParseException("Classpath resource not found: " + resourcePath);
      return parse(is);
    } catch (java.io.IOException e) {
      throw new PipelineParseException("Failed to load classpath resource: " + resourcePath, e);
    }
  }
